...
class GenerationMixin:
    ...
    def _validate_model_kwargs(self, model_kwargs: Dict[str, Any]):
        ...
        model_args |= {"student_attention_mask"}
    ...
    def generate(
            ...
            student_attention_mask:Optional[torch.LongTensor] = None,
    ...
    def contrastive_greedy_decode(
        ...
        if debug:
            ...
            tokenizer = AutoTokenizer.from_pretrained("/app/data/llama2-7b-chat-hf")
        while True:
            if synced_gpus:
                # Under synced_gpus the `forward` call must continue until all gpus complete their sequence.
                # The following logic allows an early break if all peers finished generating their sequence
            ...
            if not v2:
                ...
                if relative_top > 0.0:
                    ...
                    mask = final_logits[0] == 0.0
                    base_probs[0][mask] = 0.0  
                diff_probs = torch.nn.functional.relu(final_probs - lam*base_probs)
